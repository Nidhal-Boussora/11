...
public class annonce {
    ...
    public annonce(float prix, String titre, String categorie, String gouvernorat, String ville, String description, int numtel) {
        this.prix = prix;
        this.titre = titre;
        this.categorie = categorie;
        this.gouvernorat = gouvernorat;
    ...
    public annonce(float prix, String titre, String gouvernorat, String ville, String description, int numtel) {
        this.prix = prix;
        this.titre = titre;
        this.gouvernorat = gouvernorat;
        this.ville = ville;
